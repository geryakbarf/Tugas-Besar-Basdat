    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Data Supir
                    <a href="tambah-supir.php"><button class="btn btn-primary" type="button" style="margin-bottom: 10px;float: right;">Tambah
                        Data
                    </button></a>
                </h3>
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid"
                            ...
                            <table class="table dataTable my-0" id="dataTable">
                                ...
                                if ($db->connect_errno == 0) {
                                    $res = $db->query("SELECT * FROM supir LIMIT $posisi,$batas ");
                                    if ($res) {
                                        ...
                                        for ($i = 1; $i <= $jmlhalaman; $i++)
                                            if ($i != $halaman) {
                                                ...
                                                <li class="page-item"><a class="page-link"
                                                                         href="supir.php?halaman=<?php echo $i ?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            } else {
                                                ?>
