    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-1">Tambah Supir</h3>
                <div class="card" style="margin-top: 20px;">
                    <div class="card-body">
                        <form name="f" method="post" action="proses/proses-tambah-supir.php">
                        <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text">ID</span></div><input class="form-control" type="text" name="id" required maxlength="5">
                        ...
                        <div class="input-group" style="margin-top: 20px;">
                            ...
                            <div class="input-group-append"></div>
                        </div><button class="btn btn-primary" type="submit" name="TblSimpan" style="float: right;margin-top: 20px;">Simpan</button></form></div>
                </div>
            </div>
        </div>
