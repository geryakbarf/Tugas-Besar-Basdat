    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Data Jadwal
                   <a href="tambah-jadwal.php"> <button class="btn btn-primary" type="button" style="margin-bottom: 10px;float: right;">Tambah
                        Data
                    </button></a>
                </h3>
                            ...
                            <table class="table dataTable my-0" id="dataTable">
                                ...
                                if ($db->connect_errno == 0) {
                                    $res = $db->query("SELECT jadwal.kode_jadwal, jadwal.tanggal_berangkat, jadwal.jam_berangkat, jadwal.rute, jadwal.armada, supir.nama, jadwal.sisa_kursi, jadwal.status 
                                                                FROM jadwal JOIN supir ON jadwal.supir=supir.id_supir ORDER BY jadwal.tanggal_berangkat DESC LIMIT $posisi,$batas ");
                                    if ($res) {
                                ...
                                <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                    <ul class="pagination">
                                        ...
                                        for($i=1;$i<=$jmlhalaman;$i++)
                                            if ($i != $halaman){
                                                ?>
                                                <li class="page-item"><a class="page-link" href="jadwal.php?halaman=<?php echo $i?>"><?php echo $i?></a></li>
                                        <?php
                                            }
                                            else{
                                                ?>
