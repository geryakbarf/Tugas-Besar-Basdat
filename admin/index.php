        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-dark mb-0">Data Hari Ini</h3></div>
                <div class="row">
                        ...
                        <div class="card shadow border-left-primary py-2">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span>Jadwal keberangkatan</span>
                                        </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-warning py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"><span>Armada Berangkat</span>
                                        </div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span><?php
                                                foreach ($armada as $data){
                                                echo $data['jumlah'];}?></span></div>
                                    </div>
